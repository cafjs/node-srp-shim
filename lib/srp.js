...
/*
 * Adapted from https://github.com/justmoon/node-bignum.git
 *
 * license": "MIT/X11"
 *
 * "author": {
...
/*
 * End of 'Adapted from https://github.com/justmoon/node-bignum.git'
 *
 */
...
function padToN(number, params) {
  ...
  return padTo(toBuffer(number), params.N_length_bits/8);
}
...
function padToH(number, params) {
  ...
  return padTo(toBuffer(number), hashlen_bits/8);
}
